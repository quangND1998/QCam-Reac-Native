...
import { Center, Container, Heading, Button, Text, Box, Stack, Icon, ZStack, FormControl, Image, Link, Input, HStack, VStack, Pressable, useToast, AspectRatio, Flex, ImageBackground  } from 'native-base';
    ...
    return (
        ...
        <Box className="relative h-full " >
            ...
            <Box className=" mt-[60px] absolute top-0 left-0 w-full h-full px-4 py-4 ">
                ...
                <Button className="w-full mt-6 p-2.5 text-white bg-[#F78F43] focus:text-[#F78F43] rounded-xl" size='md' text="submit" onPress={submitHandler}>Login</Button>
            </Box>
